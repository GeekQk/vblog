...
const (
	Service_CreateComment_FullMethodName = "/vblog.comment.Service/CreateComment"
)
...
func (c *serviceClient) CreateComment(ctx context.Context, in *CreateCommentRequest, opts ...grpc.CallOption) (*Comment, error) {
	out := new(Comment)
	err := c.cc.Invoke(ctx, Service_CreateComment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) CreateComment(context.Context, *CreateCommentRequest) (*Comment, error) {
...
func _Service_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).CreateComment(ctx, req.(*CreateCommentRequest))
	}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "vblog.comment.Service",
